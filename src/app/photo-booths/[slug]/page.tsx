        ...
        <Section id="gallery" className="bg-white">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-5">
                {booth.galleryImages.map((image, index) => (
                    <div
                      key={index}
                      className={`group relative aspect-video w-full overflow-hidden rounded-[24px] border border-slate-200/70 bg-slate-200 shadow-sm transition-transform duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(15,23,42,0.18)] ${
                        index % 2 === 0 ? "mt-2" : "mb-2"
                      }`}
                    >
                        <Image
