...
export default function BoothCard({ booth }: BoothCardProps) {
  return (
    <Link href={routes.booths.detail(booth.slug)}>
        <Card className="group flex flex-col h-full overflow-hidden transition-all duration-300 ease-out shadow-[0_18px_45px_rgba(15,23,42,0.04)] hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            ...
            <CardContent className="flex flex-1 flex-col p-6 md:p-7">
                <Badge variant="outline" className="w-fit uppercase text-xs tracking-widest">
                    {booth.boothType}
                </Badge>
            ...
            <CardFooter className="flex items-center justify-between p-6 md:p-7 pt-0">
                <p className="text-base font-semibold text-fuchsia-600">
                from AED {booth.startingPrice}
                </p>
                <div className="text-sm font-medium text-fuchsia-600 inline-flex items-center">
                View Details
